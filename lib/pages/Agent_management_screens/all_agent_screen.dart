...
class AllAgentScreen extends StatefulWidget {
  const AllAgentScreen({Key? key}) : super(key: key);
            ...
            Expanded(
              ...
              child: Container(
                child: Column(
                  children: [
                    ListView.builder(
                        itemCount: approvals.isEmpty ? 0 : approvals.length,
                        shrinkWrap: true,
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: ListTile(
                              ...
                              leading: approvals[index].photo!.isNotEmpty
                                  ? CircleAvatar(
                                      radius: 30,
                                      backgroundImage: NetworkImage(
                                          '${approvals[index].photo}',
                                          scale: 1),
                                    )
                                  : CircleAvatar(
                                      radius: 30,
